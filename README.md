...
- [Kontekstolog — Yandex Direct + Metrika](https://kontekstolog.online) `https://kontekstolog.online/mcp`
  🔐 - Manage Yandex Direct advertising campaigns and Yandex Metrika analytics via natural language.
