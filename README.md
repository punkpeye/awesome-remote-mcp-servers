...
- [Vend API Merchant](https://extract.paypercall.dev) `https://extract.paypercall.dev/mcp`
  ...
  🔓 - Pay-per-call web-intel API settled in Nano (XNO): extract a page to clean markdown, check links, domain WHOIS/DNS/SSL, web search, geoIP and Nano account info. Feeless, no API key; settle per call via x402.
