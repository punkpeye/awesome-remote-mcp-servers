...
- [HostDeFi](https://hostdefi.com) `https://hostdefi.com/api/v1/mcp`
  🔓 - Token-safety intelligence for agents: free A+–F token scans (Solana + 8 EVM chains; mint/freeze authority, liquidity depth, holder concentration, contract flags) plus x402-paid intel — verdicts, pre-graduation launch signals, wallet audits, trend radar. No signup for the free scan.
