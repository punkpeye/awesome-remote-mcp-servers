...
- [Dynamoi](https://dynamoi.com/docs/mcp-server) `https://dynamoi.com/mcp`
  [![Dynamoi MCP connector](https://glama.ai/mcp/connectors/io.github.getDynamoi/dynamoi/badges/score.svg)](https://glama.ai/mcp/connectors/io.github.getDynamoi/dynamoi)
  🔐 - Music marketing for AI agents: free Spotify Smart Links, promotion campaigns, analytics, and music distribution.
