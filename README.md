...
- [Playgama](https://playgama.com/mcp/) `https://developer.playgama.com/api/mcp`
  ...
  🔐 - Publish HTML5 games from your agent in seconds, then audience, ad monetization and analytics: game form, builds, covers, in-app catalog, sandbox link, DSP traffic.
